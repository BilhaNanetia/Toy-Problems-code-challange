 //Prompt for the user to key in the basic salary
 let basicSalary = parseFloat(prompt("Enter the basic salary:"));

 //prompt for the user to key in the benefits
 ...
 //Function to check the payee rates against the taxable income prompted by the user
 function payeeRate() {
  if (taxablePay > 0 && taxablePay <= 24000) {
   ...
   //function to check the nhif rates against the taxable income prompted by the user
   function nhifRates() {
   ...
   //Function to check the nssf rates against the taxable income prompted by the user
   function nssfRates() {
